...
go_repository(
    ...
    sum = "h1:ZJbpK4gQJD8ueZjgv8JHOGQ/jiFyBVss1oIwQkkQhcQ=",
    version = "v0.0.0-20190322174617-17282ff210b3",
)

go_repository(
    name = "com_github_jhump_goprotoc",
    importpath = "github.com/jhump/goprotoc",
    sum = "h1:VFu8NxlzVAsHKStxwqFzoGLLySZ9rQc/E5Elpu4x91k=",
    version = "v0.2.0",
)
...
go_repository(
    ...
    sum = "h1:ZvI3lsq5AIkr7axxmT3tfwFlJVRFLqe6Fp0W03+MJ38=",
    version = "v0.0.0-20170818010345-ee236bd376b0",
)

go_repository(
    name = "org_golang_google_grpc",
    importpath = "google.golang.org/grpc",
    sum = "h1:HN69LlNA/SpyBIRxTfuU0QOntYfdeEeBWlVhRHRCOyw=",
    version = "v1.8.0",
)
