...
begin_declarations;
  ...
  begin_struct("f_struct");
    ...
    begin_struct("f_nested_struct_array");
      declare_integer("f_int32");
      declare_string("f_string");
    end_struct("f_nested_struct_array");
  end_struct("f_struct");
  ...
  begin_struct("struct");
    ...
    end_struct("enum");
  end_struct("struct");
  begin_struct("MapStruct");
    begin_struct("enum");
      declare_integer("FOO");
      declare_integer("BAR");
    end_struct("enum");
  end_struct("MapStruct");
end_declarations;
    ...
    size_t module_data_size)
{
  ...
  if (pb->f_struct != NULL) {
    ...
    if (pb->f_struct->f_nested_struct != NULL) {
      ...
      set_string(pb->f_struct->f_nested_struct->f_string, module_object, "f_struct.f_nested_struct.f_string");
    }

    if (pb->f_struct->f_nested_struct_array != NULL) {
      set_integer(pb->f_struct->f_nested_struct_array->f_int32, module_object, "f_struct.f_nested_struct_array.f_int32");
      set_string(pb->f_struct->f_nested_struct_array->f_string, module_object, "f_struct.f_nested_struct_array.f_string");
    }
  }
  ...
  for (int i = 0; i < pb->n_f_map_struct; i++) {
    ...
    if (pb->f_map_struct[i] != NULL) {
      ...
      if (pb->f_map_struct[i]->value != NULL) {
        ...
        set_integer(pb->f_map_struct[i]->value->f_enum, module_object, "f_map_struct[%s].f_enum", pb->f_map_struct[i]->key);
      }
    }
  }
  ...
  if (pb->f_oneof_case == 21) {
    ...
    if (pb->f_oneof_struct != NULL) {
      ...
      set_integer(pb->f_oneof_struct->f_enum, module_object, "f_oneof_struct.f_enum");
    }
  }
  ...
  set_integer(0, module_object, "MapStruct.enum.FOO");
  set_integer(1, module_object, "MapStruct.enum.BAR");
